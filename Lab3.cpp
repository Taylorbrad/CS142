...
int main() {
	...
	cout << "Which is more important, gas consumption or total cost? (Gas or Total): ";
	cin >> userSelection;
	...
	cout << "Total cost over 5 years: $" << totalCostNonHybrid << endl << endl;2

	if (userSelection.compare("Gas") == 0 && totalGallonsHybrid > totalGallonsNonHybrid)
	{
	...
	else if (userSelection.compare("Gas") == 0 && totalGallonsHybrid < totalGallonsNonHybrid)
	{
	...
	else if (userSelection.compare("Total") == 0 && totalCostHybrid > totalCostNonHybrid)
	{
		optionOne = nonHybridString;
		optionTwo = hybridString;
	...
	{
		cout << "Please enter Gas or Total.";
	}
